...
DESTDIR =
srcdir = .
builddir = /home/summerkk/ICS/SSDUP
prefix = /home/summerkk/ICS/pvfs_install
...
LDFLAGS = -L/home/summerkk/ICS/SSDUP/lib
LDFLAGS +=  -L/usr/lib64 -L/usr/lib -rdynamic
SERVER_LDFLAGS = -L/home/summerkk/ICS/SSDUP/lib
SERVER_LDFLAGS +=  -L/usr/lib64 -L/usr/lib -rdynamic -L/usr/lib64 -L/usr/lib 
DB_CFLAGS = 
LDSHARED = $(CC) -shared -L/home/summerkk/ICS/SSDUP/lib
PICFLAGS = -fPIC
...
cscope:
	find /home/summerkk/ICS/SSDUP -iname "*.[ch]" -o -iname "*.sm" \
		 > $(srcdir)/cscope.files
	( cd /home/summerkk/ICS/SSDUP; cscope -be -i /home/summerkk/ICS/SSDUP/cscope.files )
